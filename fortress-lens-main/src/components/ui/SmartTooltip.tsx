...
function SeverityPill({ level }: { level?: string }) {
  ...
  return (
    <span
      className={cn(
        "inline-block px-1.5 py-0.5 rounded text-xs font-bold uppercase tracking-wide leading-none",
      ...
      <TooltipPrimitive.Portal>
        ...
        >
          ...
          <div className="px-3 py-2.5 space-y-2.5">
            <p className="text-xs text-popover-foreground leading-relaxed">{explanation}</p>

            <div className="space-y-0.5">
              <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground leading-none">
                Risk Implication
              </p>
              <p className="text-xs text-popover-foreground leading-relaxed">{riskImplication}</p>
            </div>
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-popover-foreground leading-relaxed">{recommendedAction}</p>
            </div>
          </div>
